...
# EMalina, 2021-Dec-11, Added Track Class properties and methods
#------------------------------------------#
...
class Track():
    ...
    @length.setter
    def length(self, lng):
        if str(lng).isnumeric():
            self.__length = lng
        else:
            raise Exception('Non-numeric length')
...
class CD:
    ...
    # -- Constructor -- #
    #def __init__(self, cd_id: int, cd_title: str, cd_artist: str, trcks: list) -> None:
