...
# EMalina, 2021-Dec-12, added 'c' choose cd functionality for sub-menu
#------------------------------------------#
    ...
    if strChoice == 'l':
        ...
        while True:
            ...
            if cdChoice == 'a':
                ...
                while True:
                    try:
                        deltrack = int(input('Select the track position you would like to remove ').strip())
                        cd.rmv_track(deltrack)
                        break
                    except Exception: 
                        raise Exception('That is not an integer. Please input an integer')
